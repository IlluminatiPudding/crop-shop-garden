...
const Pulses = () => {
  return (
    <Container>
      ...
      <Wrapper>
        <ImgContainer>
          <Image src="https://images.unsplash.com/photo-1552585960-0e1069ce7405?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8bGVudGlsfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"/>
       </ImgContainer>
        <InfoContainer>
          <Title>Pulses</Title>
          <Desc>
            Order in bulk for Extra discount.<br/>
            Full of proteins.<br/>
