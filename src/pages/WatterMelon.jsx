...
const WaterMelon = () => {
  return (
    <Container>
      ...
      <Wrapper>
        <ImgContainer>
          <Image src="https://images.unsplash.com/photo-1587049352846-4a222e784d38?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8d2F0ZXJtZWxvbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"/>
       </ImgContainer>
        <InfoContainer>
          <Title>WaterMelon</Title>
          <Desc>
            Juicy Neutritious Waterry Melons.<br/>
            Your Summer time treat is back in Stock.<br/>
