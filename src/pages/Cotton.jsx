...
const Cotton = () => {
  return (
    <Container>
      ...
      <Wrapper>
        <ImgContainer>
          <Image src="https://images.unsplash.com/photo-1616431101491-554c0932ea40?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8Y290dG9ufGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"/>
       </ImgContainer>
        <InfoContainer>
          <Title>Cotton</Title>
          <Desc>
            Industrial Quality Cotton.<br/>
            Grown with lots of water and care.<br/>
